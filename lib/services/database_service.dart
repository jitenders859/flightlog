...
class DatabaseService extends ChangeNotifier {
  ...
  // Get all teachers (for admin)
  Future<List<UserModel>> getAllDispatchers() async {
    try {
      QuerySnapshot snapshot =
          await _firestore
              .collection(AppConstants.usersCollection)
              .where('role', isEqualTo: AppConstants.roleDispatch)
              .get();
      ...
      print('Error getting dispatchers: $e');
      return [];
    }
  }
  ...
  Future<Map<String, double>?> getSchoolLocation() async {
    try {
      ...
      if (doc.exists && doc.data() != null) {
        ...
        return {
          'latitude':
              data['schoolLatitude'] ?? AppConstants.defaultSchoolLatitude,
          'longitude':
              data['schoolLongitude'] ?? AppConstants.defaultSchoolLongitude,
        };
      }
